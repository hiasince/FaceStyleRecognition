...
/*int CDECL Detect_FaceLandMark(KScRgbImage2d* sourceImg,KScRgbImage2d* destImg)*/
int CDECL Detect_FaceLandMark(KScRgbImage2d* par0,KScRgbImage2d* par1,int* par2);
